<p style="text-align: left;">Operating System</p>   |  <a href="#" target="_blank"> WaveOS (v1.4) </a>  </br> <a href="#" target="_blank"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaeH-_N07SOt_mhm31HnhPWPuX_K4Ky7QykZnR5hLGnRkku7Go" width="110" > </a>
:-------------: | :-------------:
<p style="text-align: left;">Features</p> | <p style="text-align: left;">x5 times faster internet </p> <p style="text-align: left;">x10 more security & privacy </p> <p style="text-align:left;">Smart Home Control (IoT) </p> <p style="text-align:left;">Energy Monitoring </p> <p style="text-align:left;"> Multi-Room Audio/ Video inc.</p> <p style="text-align:left;"> IPCCTV </p> <p style="text-align:left;">Self-Upgrading & Upgrading  </p> <p style="text-align:left;">IPTV - Live Streaming
<p style="text-align: left;">Hardware</p> | <a href="https://github.com/unclehowell/WaveOS/blob/master/parts-list.csv" target="_blank"> WaveBOX (v1.0) </a> </br>  <img src="http://image.ibb.co/cd0n0x/wave_box_small.png" >
