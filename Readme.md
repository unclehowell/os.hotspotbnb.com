...
:--------------------------: | :-------------
 Features | <ul><li>x5 times faster internet</li><li>x10 more security & privacy </li><li><a href="https://github.com/unclehowell/WaveOS_App--openhab-distro">OpenHaB</a> Smart Home Control (IoT) </li><li>Multi-Room Audio/ Video inc.</li><li> IP CCTV Cameras </li><li>Self-Updating & Upgrading</li><li>IPTV - Live Streaming
