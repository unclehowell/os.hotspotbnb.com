...
:--------------------------: | :-------------:
 Features | <ul><li><p style="margin-left:0px!important;">x5 times faster internet</p></li><li>x10 more security & privacy </li><li>Smart Home Control (IoT) </li><li>Multi-Room Audio/ Video inc.</li><li> IP CCTV Cameras </li><li>Self-Updating & Upgrading</li><li>IPTV - Live Streaming
