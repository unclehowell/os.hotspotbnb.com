...
:-------------: | :------------- |:-------------:
<a href="#" target="_blank"> WaveOS (v1.4) </a> | What you'll Love! | <a href="https://github.com/unclehowell/WaveOS/blob/master/parts-list.csv" target="_blank"> WaveBOX (v1.0) - Kit List </a>
