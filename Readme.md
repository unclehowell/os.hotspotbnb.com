...
:-------------: | :-------------:
  Features  | 1. x5 times faster internet </br text-align="left">2. x10 more security & privacy </br>3. Smart Home Control (IoT) </br>4. Energy Monitoring </br>5. Multi-Room Audio/ Video inc.</br>6. IPCCTV </br>7. Self-Upgrading & Upgrading  </br>8. IPTV 
