...
:--------------------------: | :-------------:
 Features | <ul><li style="text-align:left;">x5 times faster internet</li><li>x10 more security & privacy </li><li>Smart Home Control (IoT) </li><li>Multi-Room Audio/ Video inc.</li><li> IP CCTV Cameras </li><li>Self-Updating & Upgrading</li><li>IPTV - Live Streaming
