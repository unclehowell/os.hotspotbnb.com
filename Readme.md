...
:-------------: | :------------- |:-------------:
<a href="#" target="_blank"> <img src="http://thumb.ibb.co/n9OUDH/wave_box.png" width="300"></a> </br> </br> <a href="https://github.com/unclehowell/WaveOS/blob/master/parts-list.csv" target="_blank"> Parts List, Suppliers & Prices </a> | - x5 times faster internet </br> - x10 more security & privacy </br> - Smart Home Control (IoT) </br> - Energy Monitoring </br> - Multi-Room Audio/ Video inc. IPTV </br>  - IPCCTV </br> - Self-Upgrading & Upgrading         | <a href="#" target="_blank"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaeH-_N07SOt_mhm31HnhPWPuX_K4Ky7QykZnR5hLGnRkku7Go" width="220" ></a>
