The master server is where each device connected to the network will look to in order to update EPG guide data and other centralised information points
