...
RED='\033[0;31m'
NC='\033[0m' # No Color
printf "\n\n${RED}UnclehowellOS-version-0-4-1${NC} - The system will now update from version 0.4.0 to version 0.4.1\n\n"
...
cd /etc/cron.daily
rm -r prep-update.sh
wget https://raw.githubusercontent.com/unclehowell/UnclehowellOS/master/updates/current/prep-update.sh
...
RED='\033[0;31m'
NC='\033[0m' # No Color
printf "\n\n${RED}UnclehowellOS is now at version 0.4.1${NC} - Self-destructing this update script so it wont run again and create a loop\n\n" ;

cd

# Then we systematically erase the content of this file to avoid it running again. 
cd /usr/lib/UnclehowellOS-updates
printf 'sleep 15\n sudo rm -r /usr/lib/UnclehowellOS-updates/00-04-01.sh\n sudo touch /usr/lib/UnclehowellOS-updates/00-04-01.sh\n' > 00-04-01-01.sh
