...
sudo apt install xserver-xorg-video-fbdev xserver-xorg-input-libinput nodm fonts-noto openbox unclutter chromium-browser -y

# I added unclutter to hide the mousepointer, as stated here: https://blockdev.io/raspberry-pi-2-and-3-chromium-in-kiosk-mode/
