...
# for this to work nicely some preparation has to be done

# this script assumes apache2 is configured for cgi in the hosting set-up process
# the assumptions include the apache2.conf file is the one from the repo and the target directory for the perl is /usr/lib/cgi-bin
