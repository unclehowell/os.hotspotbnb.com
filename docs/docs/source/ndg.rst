...
For further reading, I'd recommend you to look at the part `how to set up git for easy deployment <http://WaveOS.readthedocs.org/en/latest/source/git_workflow.html#integration-with-github>`_.
