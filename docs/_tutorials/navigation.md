...
For more details on the `group_by` filter, see [Jekyll's Templates documentation](https://unclehowell.github.io/////docs/templates/) as well as [this Siteleaf tutorial](https://www.siteleaf.com/blog/advanced-liquid-group-by/). For more details on the `sort` filter, see [sort](https://shopify.github.io/liquid/filters/sort/) in Liquid's documentation.
